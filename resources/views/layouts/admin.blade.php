        ...
        <aside class="w-64 bg-black text-white fixed h-full z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300" id="sidebar">
            ...
            <nav class="mt-6 px-4">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.backups.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.backups.*') ? 'bg-white text-black' : 'text-gray-300 hover:bg-gray-800' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
