...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-slate-900 mt-2">Create Portfolio</h1>
</div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" required
                        class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 resize-none">{{ old('description') }}</textarea>
                </div>

                <div>
                    <label for="content" class="block text-sm font-medium text-slate-700 mb-2">Content</label>
                    <textarea id="content" name="content" rows="10"
                        class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 resize-y">{{ old('content') }}</textarea>
                </div>
