...
<div class="max-w-2xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-900 mt-2">Edit Category</h1>
    </div>

    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="bg-white rounded-xl shadow-lg p-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 resize-none">{{ old('description', $category->description) }}</textarea>
            </div>
